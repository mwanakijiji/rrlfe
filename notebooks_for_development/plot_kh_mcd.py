...
g = sns.relplot(
    ...
    hue="[Fe/H]", size="phase", edgecolor="k",
...
plt.text(balmer_dummy[0]+0.1,20+0.5,"-0.9 < [Fe/H] < -0.1")
'''
...
plt.text(balmer_dummy[3]+0.1,15+0.5,"-1.7 < [Fe/H] < -0.9")
'''
...
plt.text(balmer_dummy[6]+0.1,10+0.5,"-2.5 < [Fe/H] < -1.7")
