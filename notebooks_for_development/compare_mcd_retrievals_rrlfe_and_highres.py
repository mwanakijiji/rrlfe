...
'''
plt.scatter(df_retrievals_all["feh_mapped"], df_retrievals_all["feh_retrieved"], c=df_retrievals_all["phase"], zorder=3)
...
plt.scatter(df_retrievals_all["feh_mapped"], df_retrievals_all["feh_retrieved"], c=df_retrievals_all["phase_from_zero"], zorder=3)
plt.plot([-2.5,0.0],[-2.5,0.0], linestyle="--", color="gray", zorder=2)
plt.colorbar()
