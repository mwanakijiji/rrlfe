...
step = pipeline.create_spec_realizations.CreateSpecRealizationsMain(
    ...
    unnorm_noise_churned_spectra_dir_read=stem_abs+"rrlfe_io_20230810_mcd_raw/realizations_output/",
    bkgrnd_output_dir_write=stem_abs+"rrlfe_io_20230810_mcd_raw/realizations_output/norm/",
    final_spec_dir_write=stem_abs+"rrlfe_io_20230810_mcd_raw/realizations_output/norm/final/",
    noise_level=0.0,
...
step = pipeline.run_robo.Robo(
    ...
    normzed_spec_dir_read=stem_abs+"rrlfe_io_20230810_mcd_raw/realizations_output/norm/final/",
    robo_output_write=stem_abs+"rrlfe_io_20230810_mcd_raw/robospect_output/smo_files/")
...
step = pipeline.scrape_ew_and_errew.Scraper(
    module_name="module6",
    input_spec_list_read=stem_abs+"src/mcd_final_phases_ascii_files_all.list",
    robo_output_read=stem_abs+"rrlfe_io_20230810_mcd_raw/robospect_output/smo_files/",
    file_scraped_write=stem_abs+"rrlfe_io_20230810_mcd_raw/ew_products/all_ew_info.csv")
...
step = pipeline.scrape_ew_and_errew.QualityCheck(
    module_name="module7",
    file_scraped_all_read=stem_abs+"rrlfe_io_20230810_mcd_raw/ew_products/all_ew_info.csv",
    file_scraped_good_write=stem_abs+"rrlfe_io_20230810_mcd_raw/ew_products/ew_info_good_only.csv")
...
step = pipeline.scrape_ew_and_errew.StackSpectra(
    module_name="module8",
    file_ew_data_read=stem_abs+"rrlfe_io_20230810_mcd_raw/ew_products/ew_info_good_only.csv",
    file_restacked_write=stem_abs+"rrlfe_io_20230810_mcd_raw/ew_products/restacked_ew_info_good_only.csv",
    input_spec_list_read=stem_abs+"src/mcd_final_phases_ascii_files_all.list")
...
step = pipeline.scrape_ew_and_errew.GenerateNetBalmer(
    module_name="module9",
    file_restacked_read=stem_abs+"rrlfe_io_20230810_mcd_raw/ew_products/restacked_ew_info_good_only.csv",
    file_ew_net_balmer_write=stem_abs+"rrlfe_io_20230810_mcd_raw/ew_products/restacked_ew_info_good_only_w_net_balmer.csv")
...
step = pipeline.scrape_ew_and_errew.GenerateAddlEwErrors(
    ...
    ew_data_restacked_read=stem_abs+"rrlfe_io_20230810_mcd_raw/ew_products/restacked_ew_info_good_only_w_net_balmer.csv",
    ew_data_w_net_balmer_read=stem_abs+"rrlfe_io_20230810_mcd_raw/ew_products/restacked_ew_info_good_only_w_net_balmer_errors.csv")


# add step to procedure
test_gen.add_step(step)

# use a raw calibration find Fe/H values of McD spectra
...
# apply the raw calibration to the McD star EW values, and find the correction based on them
step = pipeline.final_corrxn.FindCorrxn(
    module_name="module16",
    file_name_basis_raw_retrieved_fehs=stem_abs+"rrlfe_io_20230810_mcd_raw/bin/retrieved_vals.csv", # retrieved McD Fe/H values based on raw rrlfe calibration
    ...
    soln_write_name=stem_abs+"rrlfe_io_20230507_synthetic/bin/calib_solution_raw_abcd_20230810.fits" # raw calibration which is applied, and to which corrxn is appended to
)
