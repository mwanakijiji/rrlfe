...
step = pipeline.final_corrxn.FindCorrxn(
    ...
    soln_write_name=stem_abs+"rrlfe_io_20230507_synthetic/bin/calib_solution_abcd_20230810.fits" # raw calibration which is applied, and to which corrxn is appended to
)
