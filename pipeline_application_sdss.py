...
step = pipeline.run_robo.Robo(
    ...
    normzed_spec_dir_read=stem_abs+"rrlfe_io_20230514_sdss/realizations_output/norm/final/",
    robo_output_write=stem_abs+"rrlfe_io_20230514_sdss/robospect_output/smo_files/")
...
step = pipeline.scrape_ew_and_errew.QualityCheck(
    module_name="module7",
    file_scraped_all_read=stem_abs+"rrlfe_io_20230514_sdss/ew_products/all_ew_info.csv",
    file_scraped_good_write=stem_abs+"rrlfe_io_20230514_sdss/ew_products/ew_info_good_only.csv")
...
step = pipeline.scrape_ew_and_errew.GenerateNetBalmer(
    module_name="module9",
    file_restacked_read=stem_abs+"rrlfe_io_20230514_sdss/ew_products/restacked_ew_info_good_only.csv",
    file_ew_net_balmer_write=stem_abs+"rrlfe_io_20230514_sdss/ew_products/restacked_ew_info_good_only_w_net_balmer.csv")
...
step = pipeline.scrape_ew_and_errew.GenerateAddlEwErrors(
    ...
    ew_data_restacked_read=stem_abs+"rrlfe_io_20230514_sdss/ew_products/restacked_ew_info_good_only_w_net_balmer.csv",
    ew_data_w_net_balmer_read=stem_abs+"rrlfe_io_20230514_sdss/ew_products/restacked_ew_info_good_only_w_net_balmer_errors.csv")
...
step = pipeline.find_feh.FehRetrieval(
    ...
    file_good_ew_read=stem_abs+"rrlfe_io_20230514_sdss/ew_products/restacked_ew_info_good_only_w_net_balmer_errors.csv",
    file_calib_read=stem_abs+"rrlfe_io_20230507_synthetic/bin/calib_solution_20230507.fits",
    dir_retrievals_write=stem_abs+"rrlfe_io_20230514_sdss/bin/pickled_info/",
    file_retrievals_write=stem_abs+"rrlfe_io_20230514_sdss/bin/retrieved_vals.csv")
...
step = pipeline.final_corrxn.ApplyCorrxn(
    ...
    file_name_basis_raw_retrieved_fehs=stem_abs+"rrlfe_io_20230514_sdss/bin/retrieved_vals.csv", # retrieved McD Fe/H values based on raw rrlfe calibration
    ...
    file_name_corrected_retrieved_fehs_write=stem_abs+"rrlfe_io_20230514_sdss/bin/retrieved_vals_corrected.csv" # mapped high-res literature Fe/H values for McD stars
)
