...
step = pipeline.run_robo.Robo(
    ...
    normzed_spec_dir_read="./rrlfe_io_apply/realizations_output/norm/final/",
    robo_output_write="./rrlfe_io_apply/robospect_output/smo_files/")
...
step = pipeline.scrape_ew_and_errew.Scraper(
    module_name="module6",
    robo_output_read="./rrlfe_io_apply/robospect_output/smo_files/",
    file_scraped_write="./rrlfe_io_apply/ew_products/all_ew_info.csv",
    input_spec_list_read="./src/junk_test_synthetic_spectra.list"
    )
...
step = pipeline.scrape_ew_and_errew.QualityCheck(
    module_name="module7",
    file_scraped_all_read="./rrlfe_io_apply/ew_products/all_ew_info.csv",
    file_scraped_good_write="./rrlfe_io_apply/ew_products/ew_info_good_only.csv")
...
step = pipeline.scrape_ew_and_errew.StackSpectra(
    module_name="module8",
    file_ew_data_read="./rrlfe_io_apply/ew_products/ew_info_good_only.csv",
    file_restacked_write="./rrlfe_io_apply/ew_products/restacked_ew_info_good_only.csv",
    input_spec_list_read="./src/junk_test_synthetic_spectra.list")
...
step = pipeline.scrape_ew_and_errew.GenerateNetBalmer(
    module_name="module9",
    file_restacked_read="./rrlfe_io_apply/ew_products/restacked_ew_info_good_only.csv",
    file_ew_net_balmer_write="./rrlfe_io_apply/ew_products/restacked_ew_info_good_only_w_net_balmer.csv")
...
step = pipeline.scrape_ew_and_errew.GenerateAddlEwErrors(
    ...
    ew_data_restacked_read="./rrlfe_io_apply/ew_products/restacked_ew_info_good_only_w_net_balmer.csv",
    ew_data_w_net_balmer_read="./rrlfe_io_apply/ew_products/restacked_ew_info_good_only_w_net_balmer_errors.csv")
...
step = pipeline.find_feh.FehRetrieval(
    ...
    file_good_ew_read="./rrlfe_io_apply/ew_products/restacked_ew_info_good_only_w_net_balmer_errors.csv",
    file_calib_read="calib_solution_20220623_1.fits",
    dir_retrievals_write="./rrlfe_io_apply/bin/pickled_info/",
    file_retrievals_write="./rrlfe_io_apply/bin/retrieved_vals.csv")
