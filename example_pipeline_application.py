...
step = pipeline.create_spec_realizations.CreateSpecRealizationsMain(
    ...
    bkgrnd_output_dir_write=stem_abs+"rrlfe_io_apply/realizations_output/norm/",
    final_spec_dir_write=stem_abs+"rrlfe_io_apply/realizations_output/norm/final/",
    noise_level=0.0,
...
step = pipeline.run_robo.Robo(
    ...
    normzed_spec_dir_read=stem_abs+"rrlfe_io_apply/realizations_output/norm/final/",
    robo_output_write=stem_abs+"rrlfe_io_apply/robospect_output/smo_files/")
...
step = pipeline.scrape_ew_and_errew.QualityCheck(
    module_name="module7",
    file_scraped_all_read=stem_abs+"rrlfe_io_apply/ew_products/all_ew_info.csv",
    file_scraped_good_write=stem_abs+"rrlfe_io_apply/ew_products/ew_info_good_only.csv")
...
step = pipeline.scrape_ew_and_errew.StackSpectra(
    module_name="module8",
    file_ew_data_read=stem_abs+"rrlfe_io_apply/ew_products/ew_info_good_only.csv",
    file_restacked_write=stem_abs+"rrlfe_io_apply/ew_products/restacked_ew_info_good_only.csv",
    input_spec_list_read=stem_abs+"src/junk_test_synthetic_spectra.list")
...
step = pipeline.scrape_ew_and_errew.GenerateNetBalmer(
    module_name="module9",
    file_restacked_read=stem_abs+"rrlfe_io_apply/ew_products/restacked_ew_info_good_only.csv",
    file_ew_net_balmer_write=stem_abs+"rrlfe_io_apply/ew_products/restacked_ew_info_good_only_w_net_balmer.csv")
...
step = pipeline.scrape_ew_and_errew.GenerateAddlEwErrors(
    ...
    ew_data_restacked_read=stem_abs+"rrlfe_io_apply/ew_products/restacked_ew_info_good_only_w_net_balmer.csv",
    ew_data_w_net_balmer_read=stem_abs+"rrlfe_io_apply/ew_products/restacked_ew_info_good_only_w_net_balmer_errors.csv")
